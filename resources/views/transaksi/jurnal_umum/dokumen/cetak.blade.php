    ...
    <div class="container">
        @foreach ($transaksi as $trx)
            @php
                ...
                if (
                    $keuangan->startWith($trx->rek_debit->kode_akun, '5.') &&
                    ($keuangan->startWith($trx->rek_kredit->kode_akun, '1.1.01') ||
                        $keuangan->startWith($trx->rek_kredit->kode_akun, '1.1.02'))
                ) {
                    $files = 'BUKTI MEMORIAL';
                ...
                if (
                    ($keuangan->startWith($trx->rek_debit->kode_akun, '1.1.01') ||
                        $keuangan->startWith($trx->rek_debit->kode_akun, '1.1.02')) &&
                    $keuangan->startWith($trx->rek_kredit->kode_akun, '4.')
                ) {
                    $files = 'BUKTI MEMORIAL';
                    $kuitansi = 'bm';
                }
                            ...
                            <div style="display: flex; align-items: center; font-size: 8px;">
                                <table>
                                    <tr>
                                        <td>Nomor</td>
                                        <td>:</td>
                                        <td><?php echo $trx->id . '/' . strtoupper($kuitansi); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal</td>
                                        <td>:</td>
                                        <td>{{ Tanggal::tglIndo($trx->tgl_trx) }}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                ...
                <div class="box-body">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="keterangan">
                                Debit
                                {{ ucwords($trx->rek_debit->kode_akun . ' - ' . $trx->rek_debit->nama_akun) }}
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">&nbsp;</td>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td align="center">{{ $dir->nama }}</td>
                            <td align="center">{{ $sekr->nama }}</td>
                        </tr>
                    </table>
                </div>
            </div>
