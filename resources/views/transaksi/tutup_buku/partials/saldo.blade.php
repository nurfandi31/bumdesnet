...
@foreach ($akun1 as $lev1)
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-body p-0 pe-1 pb-1 pt-1 ps-1">
                    <div class="table-responsive">
                        <table class="table table-striped  rounded overflow-hidden">
                            <thead>
                                <tr class="bg-dark">
                                    <th class="text-white" width="10%">Kode Akun</th>
                                    <th class="text-white">Nama Akun</th>
                                    <th class="text-white" width="30%">Saldo</th>
                                </tr>
                            </thead>
                            <tbody>
...
<form action="/transactions/tutup_buku" method="post" id="FormSimpanTutupBuku">
    ...
    <div class="card mb-4">
        <div class="card-body  p-2 pe-2 pb-2 pt-2 ps-2">
            <div class="col-12 d-flex justify-content-end">
                <button class="btn btn-info" type="submit" id="SimpanTutupBuku">
                    <span class="text-white"> Lanjutkan Tutup Buku</span>
                </button>
            </div>
        </div>
    </div>
