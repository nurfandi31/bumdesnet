...
@section('content')
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped table-hover" id="blokir">
                        <thead>
                            <tr>
                                <th>No.Induk</th>
                                <th>Pelanggan</th>
...
@section('script')
    <script>
        let table = setAjaxDatatable('#blokir', '{{ url('/installations/blokir') }}', [{
                data: 'kode_instalasi',
                name: 'kode_instalasi'
            },
            {
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    if (data == 'B') {
                        return '<span class="badge bg-warning">Menunggak</span>';
                    }
                }
            }
        ]);
        ...
        $('#blokir').on('click', 'tbody tr', function() {
